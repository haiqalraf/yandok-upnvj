                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update-auth') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="oldPassword" type="password" class="form-control @error('oldPassword') is-invalid @enderror" name="oldPassword" value="{{ $oldPassword ?? old('oldPassword') }}" required autofocus>
