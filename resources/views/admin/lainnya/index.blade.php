    ...
    <ul class="nav nav-fill justify-content-center">
      <li class="nav-item">
        <a class="nav-link @if ($status === '1' || $status === null){{ 'active' }}@endif" \
          href="{{ route($adminTitle.'.lainnya', ['status' => '1']) }}">
          Belum Diproses
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link @if ($status === '2'){{ 'active' }}@endif" 
          href="{{ route($adminTitle.'.lainnya', ['status' => '2']) }}">
          Sedang Diproses
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link @if ($status === '3'){{ 'active' }}@endif" 
          href="{{ route($adminTitle.'.lainnya', ['status' => '3']) }}">
          Sudah Diproses
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link @if ($status === '0'){{ 'active' }}@endif" 
          href="{{ route($adminTitle.'.lainnya', ['status' => '0']) }}">
          Ditolak
        </a>
      </li>
    </ul>
                ...
                <tbody>
                  @foreach ($lainnya as $item)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route($adminTitle.'.lainnya.detail', ['lainnya' => $item]) }}" title="Detail"
