                ...
                <tbody>
                  @foreach ($pesanan as $item)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route($adminTitle.'.'.$type.'.detail', [$type => $item]) }}" title="Detail"
