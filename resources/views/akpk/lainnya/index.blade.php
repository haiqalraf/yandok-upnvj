...
<div class="container p-3 bg-white shadow rounded">
    <ul class="nav nav-tabs nav-fill justify-content-center">
       ...
       <li class="nav-item">
          <a class="nav-link @if ($status==='2' ){{'active'}}@endif" href="{{ route('akpk.lainnya', ['status' => '2'])}}">Sedang Diproses</a>
       </li>
       <li class="nav-item">
          <a class="nav-link @if ($status==='3' ){{'active'}}@endif" href="{{ route('akpk.lainnya', ['status' => '3'])}}">Sudah Diproses</a>
       </li>
    </ul>
